  ...
  createMessage(type, content, targetUserId, extension = null) {
    ...
    switch (type) {
      case TIM.TYPES.MSG_TEXT:
        ...
        message = this._SDKInstance.createTextMessage({
          ...params
        })
        break;
      case TIM.TYPES.MSG_FILE:
        ...
        message = this._SDKInstance.createImageMessage({
          ...params
        })
        break;
      case TIM.TYPES.MSG_CUSTOM:
        ...
        message = this._SDKInstance.createCustomMessage({
          ...params
        })
        break;
      default:
